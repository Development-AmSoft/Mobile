...
//					Razão social, Fantasia, CNPJ, IE, Cidade e Estado
...
//		}
	...
	public boolean onOptionsItemSelected(MenuItem item)
	{
		...
		case MN_SALVAR:
			...
			if (ValidaCPFCNPJ())
			{
				...
				// msg.setMessage("Cliente já foi sincronizado.\nDeverá ser sincronizado novamente para ser atualizado no SmartTools !!!").show();
				// }
				// else{
	...
	public boolean ValidaCPFCNPJ()
	{
		...
		} else if (edtCPFCNPJ.getText().toString().length() <= 11)
		{
			...
			if (!retorno)
			{
				banco.MostraMsg(this, "CPF inválido !!!");
				edtCPFCNPJ.requestFocus();
			}
		} else if (edtCPFCNPJ.getText().toString().length() > 11)
		{
			...
			if (!retorno)
			{
				banco.MostraMsg(this, "CNPJ inválido !!!");
				edtCPFCNPJ.requestFocus();
			}
		...
		if (retorno)
		{
			...
			if (rsExiste.moveToFirst())
			{
				...
				} else if (rsExiste.getInt(2) == 2)
				{
					...
					ad.setMessage("CPF/CNPJ já está cadastrado !!!\n\nNome: " + rsExiste.getString(1) + "\nSituação: " + situacao);
